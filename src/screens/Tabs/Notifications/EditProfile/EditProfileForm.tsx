    ...
    <View>
      <Item stackedLabel error={!isNil(errors.title)}>
        ...
        <Query query={REFERENCES.TITLES}>
          {({ error, loading: loadingData, data }) => {
            ...
            const { titles: { payload: { titles } } } = data;
            titleList = titles;
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={{ position: 'relative' }}>
            ...
            <Icon
              ...
              style={[styles.checkmark, emailVerified
      ...
      <Item error={!isNil(errors.mobileNumber)}>
        <View style={{ flex: 1 }}>
          ...
          <View style={{ position: 'relative' }}>
            ...
            <Icon
              name="checkmark-circle"
              style={[styles.checkmark, mobileNumberVerified
                ? styles.checkmarkVerified
                : styles.checkmarkUnverified
              ]}
            />
      ...
      >
        ...
        <DatePicker
          ...
          androidMode="default"
          onDateChange={
            value => handleChange('birthday', moment(value).format('YYYY-MM-DD'))
          }
        />
      </Item>
      <Item stackedLabel error={!isNil(errors.nationality)}>
        ...
        <Query query={REFERENCES.NATIONALITIES}>
          {({ error, loading: loadingData, data }) => {
            ...
            const { nationalities: { payload: { nationalities } } } = data;
...
EditProfileForm.propTypes = {
  ...
  mobileNumberVerified: PropTypes.bool,
